...
// based on http://www.open.com.au/mikem/arduino/Roomba/
...
public:
	...
	Roomba(Serial* serial, Baud baud = Baud57600);
	Roomba(const char* name, Baud baud = Baud57600);
	Roomba(const char* name, int rate = 57600);
	~Roomba();
